...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/grpc-stubs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12647&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/grpc-stubs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `grpc-stubs` can be installed with:

```
conda install grpc-stubs
```

It is possible to list all of the versions of `grpc-stubs` available on your platform with:
